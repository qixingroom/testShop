...
<link href="/testShop/testShop/Public/Admin/Styles/general.css" rel="stylesheet" type="text/css" />
...
.explode {
  background:url(/testShop/testShop/Public/Admin/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/testShop/testShop/Public/Admin/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/testShop/testShop/Public/Admin/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
...
<div id="tabbar-div">
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="">
                <img id="toggleImg" src="/testShop/testShop/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            <li><a href="http://localhost/testShop/testShop/index.php/Admin/News/addNews" target="main-frame">添加新闻</a></li>
            <li><a href="http://localhost/testShop/testShop/index.php/Admin/News/editNew" target="main-frame">修改新闻</a></li>
            <li><a href="">删除新闻</a></li>
            <li><a href="http://localhost/testShop/testShop/index.php/Admin/News/listNews" target="main-frame">查看新闻</a></li>
        </ul>
    </div>
...
<script type="text/javascript" src="/testShop/testShop/Public/Admin/Js/global.js"></script>
<script type="text/javascript" src="/testShop/testShop/Public/Admin/Js/utils.js"></script>
<script type="text/javascript" src="/testShop/testShop/Public/Admin/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/testShop/testShop/Public/Admin/Images/menu_minus.gif' : '/testShop/testShop/Public/Admin/Images/menu_plus.gif';
